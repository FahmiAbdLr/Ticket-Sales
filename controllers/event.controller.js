...
exports.addEvent = (request, response) => {
    ...
    upload(request, response, error => {
        ...
        eventModel.create(newEvent).then(result => {
...
exports.updateEvent = async (request, response) => {
    ...
    upload(request, response, async error => {
        ...
        // Jika ingin update file / gambar, maka akan menghapus gambar sebelumnya jika tidak kosong lalu diganti
        if (request.file) {
...
exports.deleteEvent = async (request, response) => {
    ...
    eventModel.destroy({where: {eventID: eventID}}).then(result => {
        /** if Delete process success */
        return response.json({
            success: true,
